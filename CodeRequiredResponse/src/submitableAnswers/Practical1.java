...
// create the random and assign it 
		...
		int[] RandNumGenWithRange = Randnum.ints(userMin, numMax*userMin + 1).filter(ifuserInputMinVal.negate()).distinct().limit(numMax).toArray();
		System.out.println("--------");
